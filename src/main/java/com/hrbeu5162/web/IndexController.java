...
public class IndexController {
    ...
    public String index(@PageableDefault(size = 8, sort = {"updateTime"},
        ...
        model.addAttribute("typesCount", typeService.countType());
        model.addAttribute("tags", tagService.listTagTop(10));
        model.addAttribute("tagsCount", tagService.countTag());
    ...
    public String searchPage(@PageableDefault(size = 8, sort = {"updateTime"},
            direction = Sort.Direction.DESC) Pageable pageable,
    ...
    @GetMapping("/user/{id}")
    public String user(@PageableDefault(size = 8, sort = {"updateTime"},
